...
try {
    ...
    <# 
       Due to 3 test failures on the plugins modules that's going to take time 
       merge into master. Disabling unittests for now.
       dcos-metrics/plugins/datadog-standalone/datadog-standalone_test.go:111: Fatalf format %s has arg uptime.Host of wrong type *string
