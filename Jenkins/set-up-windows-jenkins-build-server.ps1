...
function Install-Docker {
    ...
    $dockerUrl = "http://dcos-win.westus.cloudapp.azure.com/downloads/docker/18.02.0-ce/docker.exe"
    $dockerdUrl = "http://dcos-win.westus.cloudapp.azure.com/downloads/docker/18.02.0-ce/dockerd.exe"
