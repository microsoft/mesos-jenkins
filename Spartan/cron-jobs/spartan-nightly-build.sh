...
python $PYTHON_SCRIPT -s "$GEARMAN_SERVERS_LIST" -j "$JOB_NAME" --params '{"BRANCH": "master", "MESOS_JENKINS_BRANCH": "master", "MESOS_JENKINS_REPO_URL": "https://github.com/Microsoft/mesos-jenkins"}' 2>&1 >> $LOG_FILE
